...
class GameScene: SKScene {
    ...
    override init(size: CGSize) {
        ...
        //n está sendo utilizado por enquanto.
        ...
        let wColumns: CGFloat = BlockSize * CGFloat(NumColumns)
        let hRows: CGFloat = BlockSize * CGFloat(NumRows)
        let gameBoard = SKSpriteNode(texture: gameBoardTexture, size: CGSize(width: wColumns, height: hRows))
    ...
    func animateCollapsingLines(linesToRemove: Array<Array<Block>>, fallenBlocks: Array<Array<Block>>, completion:@escaping () -> ()) {
        ...
        for rowToRemove in linesToRemove {
            for block in rowToRemove {
                ...
                let posNegRadius: CGFloat = goLeft ? -randomRadius : randomRadius
                point = CGPoint(x: point.x + posNegRadius, y: point.y)
